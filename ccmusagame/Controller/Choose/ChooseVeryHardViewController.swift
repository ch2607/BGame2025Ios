            ...
            //  print("Carl index = \(indexPath.row )")
               ...
               if myArray3[indexPath.row] == 1
               {
                   ...
                   case 0:
                       ...
                       cell.imageView.image = UIImage(named: "Choose3")
                       cell.imagestar2.image = UIImage(named: "num01")
                       if GameName.shared.error > 3
                       {
                           cell.imagestar1.image = UIImage(named:"imag2")
                       }
                       else
                       {
                           if GameName.shared.error > 2
                           {
                               cell.imagestar1.image = UIImage(named:"imag2")
                           }
                           else
                ...
                else
                {
                    ...
                    {
                        cell.imageView.image = UIImage(named: "Choose1")
                        cell.imagestar3.image = UIImage(named: "Lock")

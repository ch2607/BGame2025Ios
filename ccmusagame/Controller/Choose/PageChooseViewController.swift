...
//  ccmusagame
//
//  Created by Carl Hsieh on 9/14/22.
//  Copyright © 2022 Carl Hsieh. All rights reserved.
//

import UIKit

class PageChooseViewController: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    ...
    lazy var orderedViewControllers: [UIViewController] = {
        return [self.EasyPage(viewController: "page 1"),
                self.HardPage(viewController: "page 2"),
                self.VeryHardPage(viewController: "page 3")]
    }()
    ...
    func EasyPage(viewController: String) -> UIViewController {
        ...
        return UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "Easy") as! ChooseEasyViewController
    }
    
    func HardPage(viewController: String) -> UIViewController {
        GameName.shared.ChooseLevel = 2
        return UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "Hard") as! ChooseHardViewController
    }
    
    func VeryHardPage(viewController: String) -> UIViewController {
        GameName.shared.ChooseLevel = 3
        return UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "VeryHard") as! ChooseVeryHardViewController
    }

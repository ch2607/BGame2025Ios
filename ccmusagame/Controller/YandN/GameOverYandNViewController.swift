//
//  GameOverYandNViewController.swift
//  ccmusagame
//
//  Created by Carl Hsieh on 9/4/22.
//  Copyright © 2022 Carl Hsieh. All rights reserved.
//

import UIKit

class GameOverYandNViewController: UIViewController {
 ...
 //   let backgroundImageView = UIImageView()
    ...
    @IBAction func ContBtn(_ sender: Any)
    {
        ...
        let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "PageYandNViewController") as! PageYandNViewController
   ...
   // @IBOutlet weak var backimg: UIImageView!
    override func viewDidLoad()
    {
       ...
       super.viewDidLoad()
        ...
        let imgGif = UIImage.gifImageWithName("backimg2")
        
 
       
       backimg.image =  imgGif
      ...
      //  GameName.shared.isLastQuestion = false
        ...
        if GameName.shared.YandNlevel ==  1  // easy level
        {
            var sname = ""
            let name = "ye"
        ...
        {
            if GameName.shared.YandNlevel ==  2   // middle level
            {

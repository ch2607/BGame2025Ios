...
class YandNHardViewController: UIViewController {
...
//    let largeFont = UIFont.systemFont(ofSize: 60)
 //   let configuration = UIImage.SymbolConfiguration(font: largeFont)
    ...
    func setupCollection()
    {
       ...
       TextLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 50).isActive = true
...
extension YandNHardViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout
{
...
// print(" carl cellForItemAt = \(indexPath.section)")
        if indexPath.row < 19
        {
            ...
            if myArray2[indexPath.row] == 1
            {
                ...
                {
                case 0:
                    cell.imageView.image = UIImage(named: "ym1btn")
            ...
            else
            {
                if myArray2[indexPath.row] == 0
                {
                    ...
                    cell.imageView.image = UIImage(named: "ymstop")
    ...
    {
      //   print("Carl swidth =  \(view.frame.width)")
    ...
    {
        print("carl select 1 = \(indexPath.row)")
        print("carl select = \(indexPath.row)")
         if GameName.shared.YandNlevel == 1
         {
             ...
             {
                 let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "GameLevel") as! GameOrgViewController
                  self.present(vc, animated: true, completion: nil)
             }
         }
         else
